...
This study is part of the activities of the Modural program funded by the French National Research Agency and is conducted in collaboration with the French National Institute of Demographic Studies (INED) and the French National Scientific Research Center (CNRS), which are currently working on the adaptation of the <a href="https://mobiliscope.cnrs.fr/en" target="_new" rel="noopener"><strong>Mobiliscope project</strong></a> to Latin American metropolises. The results clearly show the persistence of the segregated socio-residential pattern of the city and the maintenance of a very marked spatial mismatch between places of residence and places of work, with the center polarizing most of the flows from the densely populated deprived outskirts.
